...
class _MapScreenState extends State<MapScreen> {
  ...
  Color _getColorForType(String type) {
    switch (type) {
      case 'Toko': return const Color.fromARGB(255, 233, 147, 214);
      case 'Kantor': return const Color.fromARGB(255, 213, 155, 231);
      case 'Rumah': default: return const Color.fromARGB(255, 115, 72, 196);
    }
  }
